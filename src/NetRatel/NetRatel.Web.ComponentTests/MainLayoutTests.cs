...
public class MainLayoutTests : AsyncBunitContext
{
    ...
    public void MainLayout_RendersApiLinkAndAuthoritativeAssemblyVersion()
    {
        ...
        cut.Find(".netratel-appbar-version-chip").TextContent.Trim().Should().Be("v0.1.0-rc.4");
    }
    ...
    {
        AppBarVersionResolver.FormatProductVersion("0.1.0-rc.4+462a556b738891d440d8b72e61ce361b1656e033")
            .Should().Be("v0.1.0-rc.4");
    ...
    public void MainLayout_RendersMobileOverflowActionsForCompactAppBar()
    {
        ...
        cut.WaitForAssertion(() =>
        {
            ...
            cut.Markup.Should().Contain("v0.1.0-rc.4");
