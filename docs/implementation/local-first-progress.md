...
| P11 | [#41](https://github.com/BostonTechnologies/netratel/issues/41) | pending | pending | In progress on release-generated OpenAPI/Scalar taxonomy, operation-level security metadata, compatibility aliases, and runnable operator documentation. |
