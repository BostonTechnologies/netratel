...
archive_has_entry "$bundle" '^\./compose\.public-https\.yaml$' "Release bundle is missing compose.public-https.yaml."
archive_has_entry "$bundle" '^\./nginx\.public-https\.conf$' "Release bundle is missing nginx.public-https.conf."
